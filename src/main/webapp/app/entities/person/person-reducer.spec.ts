...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './person.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PERSON_LIST actions', async () => {
    ...
    it('dispatches FETCH_PERSON actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PERSON actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PERSON actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PERSON actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PERSON actions', async () => {
      const expectedActions = [
        {
