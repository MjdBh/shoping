  ...
  return (
    <div>
      <h2 id="person-heading" data-cy="PersonHeading">
        <Translate contentKey="shoppingApp.person.home.title">People</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="shoppingApp.person.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="shoppingApp.person.home.createLabel">Create new Person</Translate>
          </Link>
        </div>
      </h2>
        ...
        {personList && personList.length > 0 ? (
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="shoppingApp.person.home.notFound">No People found</Translate>
            </div>
          )
        )}
      </div>
