...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SHOPPINGGROUP_LIST actions', async () => {
    ...
    it('dispatches FETCH_SHOPPINGGROUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SHOPPINGGROUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SHOPPINGGROUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SHOPPINGGROUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SHOPPINGGROUP actions', async () => {
      const expectedActions = [
        {
