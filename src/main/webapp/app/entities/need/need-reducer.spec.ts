...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './need.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NEED_LIST actions', async () => {
    ...
    it('dispatches FETCH_NEED actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_NEED actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_NEED actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_NEED actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_NEED actions', async () => {
      const expectedActions = [
        {
